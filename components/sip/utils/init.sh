...
# Seed live kamailio.cfg from baked default only if no override is mounted.
mkdir -p /etc/kamailio
[ -f /etc/kamailio/kamailio.cfg ] || cp /etc/kamailio.dist/kamailio.cfg /etc/kamailio/kamailio.cfg
